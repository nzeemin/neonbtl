...
{ //  RN      (RN)    (RN)+  @(RN)+  -(RN)   @-(RN)  X(RN)   @X(RN)
    ...
    {0x000F, 0x0020, 0x0020, 0x0029, 0x0026, 0x002A, 0x0030, 0x0037},   // (RN)
    {0x000F, 0x0024, 0x0020, 0x0029, 0x002E, 0x002A, 0x0030, 0x0037},   // (RN)+
    {0x0017, 0x0029, 0x0029, 0x002D, 0x003A, 0x0034, 0x0034, 0x003E},   // @(RN)+
    {0x0016, 0x002A, 0x0022, 0x002E, 0x002E, 0x003A, 0x0030, 0x0037},   // -(RN)
    {0x001E, 0x002E, 0x002E, 0x0030, 0x003A, 0x003E, 0x003A, 0x003E},   // @-(RN)
    {0x001D, 0x002A, 0x002A, 0x0030, 0x002E, 0x0034, 0x003F, 0x0045},   // X(RN)
